...
| **T7** Re-baseline goldens | ⬜ **unblocked** + maintainer GO | Re-baseline A1/A2 from the (fixed) scratch; overwrites committed fixtures — maintainer decision. |
