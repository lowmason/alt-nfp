...
-   **Rollback** (if the new store misbehaves downstream): restore each canonical prefix from its `-prev-20260618` S3 backup (copy back, delete orphans), or re-upload the local `data/canonical_backup_20260618/` via `mirror_store --allow-canonical`.
