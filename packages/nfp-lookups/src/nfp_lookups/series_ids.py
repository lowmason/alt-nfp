'''
BLS LABSTAT series-ID grammar for CE, SM, and EN.

Encodes series ID formats as structured data so that series IDs can be
built, parsed, and validated programmatically. Pure reference knowledge —
no I/O. The download layer (``nfp_download.bls``) re-exports these helpers.
